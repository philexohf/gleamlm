...
用法：
    python data_tools/dedup_text.py --input data/raw/news_clean.txt --output data/raw/news_dedup.txt
    python data_tools/dedup_text.py --input data/raw/baike_clean.txt --output data/raw/baike_dedup.txt
    python data_tools/dedup_text.py --input data/raw/wiki_clean.txt --output data/raw/wiki_dedup.txt
"""
