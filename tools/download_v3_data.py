...
def main():
    ...
    print("  python tools/clean_text.py --input data/raw/news_raw.txt --output data/raw/news_clean.txt --convert_zh")
    print("  python tools/clean_text.py --input data/raw/baike_raw.txt --output data/raw/baike_clean.txt --convert_zh")
