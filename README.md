...
# DPO（基于 SFT clean 模型，需先生成 DPO 数据）
python data_tools/generate_rejected.py --sft_data gleamlm-lite/data/sft_api_clean.jsonl --model_path gleamlm-lite/checkpoints/sft_best.pt --limit 500
python gleamlm-lite/dpo.py --data_path gleamlm-lite/data/dpo_data.jsonl --model_path gleamlm-lite/checkpoints/sft_best.pt

# 推理
python gleamlm-lite/infer.py --model gleamlm-lite/checkpoints/dpo/dpo_best.pt --sft --prompt "你好"
