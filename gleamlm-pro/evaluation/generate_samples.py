...
def generate_samples(model, tokenizer, prompts, max_new_tokens=256,
    ...
    for i, prompt in enumerate(prompts):
        ...
        try:
            ...
            encoded = result[len(prompt):].encode("utf-8", errors="replace")
            print(f"Generated: {encoded.decode('utf-8', errors='replace')}")
